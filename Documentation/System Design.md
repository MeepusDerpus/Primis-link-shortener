...
// Remember this is a design doc, not a discourse on various options. refactor later
...
From an implementation perspective there are various options:
- Microservices: Highly scalable, resilient and fault tolerant, bit of work to build and get running. May be overkill
- Monolith: Great for building things in start up environments, struggle to scale and cause a lot of pain in growing, adapting and tackling tech debt. 
